...
if (messager.includes('💫 Actualizando.')) messager = 'ꕥ️ Procesando, espere un momento mientras me actualizo.\n\n' + stdout.toString()
...
const errorMessage = `✿︎ Se han hecho cambios locales qué entran en conflicto con las Actualizaciones del Repositorio, Para actualizar, reinstala el Bot o realiza las actualizaciones manualmente.\n\n✰ *ARCHIVOS EN CONFLICTO*\n\n${conflictedFiles.join('\n')}`
