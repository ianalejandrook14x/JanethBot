...
conn.reply(m.chat, `✿︎ Ya has iniciado una apuesta recientemente, espera *⏱️ ${tiempoRestante}* para apostar nuevamente`, m, )
return
}
...
if (args.length < 1) return conn.reply(m.chat, '✿︎ Ingresa la cantidad de ' + `💴 *Yenes*` + ' que deseas aportar contra' + ` *JanethBot-MD*` + `\n\n` + '`Ejemplo:`\n' + `> *${usedPrefix + command}* 100`, m, )
