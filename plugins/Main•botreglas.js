...
let hutao = `✿︎ *Respeta las reglas de Janeth*\n
✰ No llamar Al Bot
✰ No hacer spam
...
⚠️ 𝗔𝘃𝗶𝘀𝗼: *Puedes apoyarnos dejando una estrellita 🌟 al repositorio oficial de Janeth.*

${global.md}`.trim()
await conn.reply(m.chat, hutao, m, )
