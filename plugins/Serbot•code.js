...
if (code !== DisconnectReason.connectionClosed) { parent.sendMessage(m.chat, { text: "✿︎ Conexión perdida con el servidor." }, { quoted: m });
}}
if (global.db.data == null) loadDatabase();
if (connection == 'open') {
conn.isInit = true;
global.conns.push(conn);
await parent.reply(m.chat, args[0] ? '✿︎ Conectado con éxito al WhatsApp.' : '✿︎ Vinculaste un Sub-Bot con éxito.', m, );
await sleep(5000);
if (args[0]) return;
