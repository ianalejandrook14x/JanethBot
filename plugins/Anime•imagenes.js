...
const res = (await axios.get(`https://raw.githubusercontent.com/ianalejandrook14xxyz/JanethBot-MD/master/src/JSON/anime-${command}.json`)).data;
await m.react(rwait)
...
await conn.sendCarousel(m.chat, '✿︎ Resultado de ' + command, '🔎 Anime - ' + command, null, messages, m);
await m.react(done)
};
