...
let txt = `✿︎ *Nombre* ${name}\n\n`
txt += `✿︎ *Nivel* ${user.level}\n`
txt += `☆ *XP* ${user.exp - min} / ${xp}\n\n`
txt += `✿︎ No es suficiente XP *${max - user.exp}* ¡De nuevo! ꕥ`
...
txt += `✿︎ *Nota:* _Cuanto más a menudo interactúes con *Janeth*, mayor será tu nivel_`
await conn.sendFile(m.chat, img, 'thumbnail.jpg', txt, m, null, )}}
