...
if (!args[0]) return conn.reply(m.chat, '✿︎ Ingrese el enlace de un archivo de Mediafire.', m, )
if (!args[0].match(/mediafire/gi)) return conn.reply(m.chat, '✿︎ El enlace deve ser de un archivo de Mediafire.', m, )
try {
await m.react(rwait)
