...
[`5493876639332`, `🌙 Propietario`, `✿︎ ιαɳαʅҽʝαɳԃɾσσƙ15x `, dev, correo, `🎌 Tokio`, `${yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Eʂ υɳ ზσƚ`, `${wm}`, `📵 Nσ ԋαƈҽɾ ʂραɱ`, correo, `🎌 Tokio`, md, biobot]
], m)

await conn.reply(m.chat,  `*❕ ${name} él es mi dueño, si quieres reportar un error contáctalo*`, m, )
}
