...
if (!args[0]) return m.reply('✿︎ Ingresa la cantidad de *💴 Yenes* que deseas Depositar.')
if ((args[0]) < 1) return m.reply('✿︎ Ingresa una cantidad válida de *💴 Yenes*.')
if (args[0] == 'all') {
...
if (!Number(args[0])) return m.reply('✿︎ La cantidad deve ser un Numero.')
