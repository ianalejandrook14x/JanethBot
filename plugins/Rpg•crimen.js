...
m.reply(`✿︎ Ya has cometido un Crimen recientemente, espera ⏱️ *${tiempo2}* para cometer tu próximo Crimen y evitar ser atrapado.`)
return
}
...
text: `✿︎¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} 💴 Yenes* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} 💴 Yenes* a ${senderName}.`,
contextInfo: { 
...
conn.reply(m.chat, `✿︎ No fuiste cuidadoso y te atraparon mientras cometias tu cirme, se restaron *-${amountSubtracted} 💴 Yenes* a ${senderName}.`, m, )
break
case 2:
...
conn.sendMessage(m.chat, {
text: `✿︎ Lograste cometer tu crimen con exito, pero te descubrieron y solo lograste tomar *${smallAmountTaken} 💴 Yenes* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} 💴 Yenes* a ${senderName}.`,
contextInfo: { 
mentionedJid: [randomUserId],
}}, { quoted: fkontak })
break
