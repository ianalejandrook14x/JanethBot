...
//m.react('✿︎') 
  ...
  const texto = `ꕥ @${m.sender.split`@`[0]}  Eɳʋιαɳԃσ ʂυ ʋιԃҽσ, ҽʂρҽɾҽ υɳ ɱσɱҽɳƚσ...`;
...
m.react('✿︎') 
    ...
    const desc1n = `Tσɱҽ ʂυ ʋιԃҽσ ԃҽ Tιƙ Tσƙ ✿︎`;
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        const te = `Tσɱҽ ʂυ ʋιԃҽσ ԃҽ Tιƙ Tσƙ ✿︎`;
